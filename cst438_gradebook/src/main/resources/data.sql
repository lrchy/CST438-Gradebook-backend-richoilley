...
(2021,'Fall',40443,'CST 363 - Introduction to Database Systems','dwisneski@csumb.edu')
;
...
(4, '2023-11-02', 'Assignment Test 1', 40443),
(5, '2023-12-10', 'Assignment Test 2', 40443)
;
